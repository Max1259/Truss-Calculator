...
int error = 0; //variable to check if truss data has errors
	...
	while (header_pos < headers.size())
	{
		...
		case 0:
			...
			while (!line.empty())//while next line is not empty
			{
				...
				if (temp.fail()) { //check the stringstream for data that doesn't match data types
					error++;
				}
				getline(get_truss, line);//get next line of data and store it into line
		...
		case 1:
			...
			while (!line.empty())//while next line is not empty
			{
				...
				if (temp1.fail()) { //check the stringstream for data that doesn't match data types
					error++;
				}
				getline(get_truss, line);//get next line of data and store it into line
		...
		case 2:
			...
			while (!line.empty())//while next line is not empty
			{
				...
				if (temp2.fail()) { //check the stringstream for data that doesn't match data types
					error++;
				}
				if (dir == 'X')
				{
				...
				else //if direction is neither X or Y, increment the error flag
				{
					error++;
				}
				getline(get_truss, line);//get next line of data and store it into line
		...
		case 3:
			...
			while (!line.empty()) //while next line is not empty
			{
				...
				if (temp3.fail()) { //check the stringstream for data that doesn't match data types
					error++;
				}
				if (dir == 'X')
				{
...
int main() {
	...
	//if the truss input file has errors, stop the program, else continue to build and solve the truss
	if (error == 1) {

		cout << "There is " << error << " error in the Truss input file. Fix the error and try again. Press 'q' to exit." << endl;
		while (1) {
		...
		cout << "There are " << error << " errors in the Truss input file. Fix the errors and try again. Press 'q' to exit." << endl;
		while (1) {
