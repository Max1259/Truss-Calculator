...
int main() {
	...
	if (error == 1) {
		cout << "There is " << error << " error in the Truss input file. Fix the error and try again." << endl;
		while (1);
	} 
	else if (error > 1) {
		cout << "There are " << error << " errors in the Truss input file. Fix the errors and try again." << endl;
		while (1);
	}
	else 
	{
